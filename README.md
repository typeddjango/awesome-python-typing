...
- [sqlalchemy2-stubs](https://docs.sqlalchemy.org/en/14/orm/extensions/mypy.html) - Stubs and mypy plugin for [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy).
